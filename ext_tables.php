...
$tempColumns = array(
	...
	'tx_generic_gallery_predefined' => Array(
		'exclude' => 1,
		'label' => 'LLL:EXT:gg_extbase/Resources/Private/Language/locallang_db.xml:generic_gallery_predefined',
		'config' => Array(
			'type' => 'select',
			'allowNonIdValues' => 1,
			'itemsProcFunc' => 'TYPO3\GgExtbase\Backend\Hooks\TcaHook->addPredefinedFields',
			'size' => 1,
			'minitems' => 0,
			'maxitems' => 1,
		)
	...
	'tx_generic_gallery_items' => Array(
		'exclude' => 1,
		'label' => 'LLL:EXT:gg_extbase/Resources/Private/Language/locallang_db.xml:generic_gallery_items',
		'config' => Array(
			'type' => 'inline',
	...
	'tx_generic_gallery_images' => Array(
		'exclude' => 1,
		'label' => 'LLL:EXT:gg_extbase/Resources/Private/Language/locallang_db.xml:generic_gallery_images',
	...
	'tx_generic_gallery_collection' => Array(
		'exclude' => 1,
		'label' => 'LLL:EXT:gg_extbase/Resources/Private/Language/locallang_db.xml:generic_gallery_collection',
		'config' => Array(
			'type' => 'inline',
