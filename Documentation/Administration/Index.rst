...
.. important::
	...
	Please note the upgrade guide if updating from previous versions!
...
Add one of the :code:`Generic Gallery: Example - Bootstrap` static TS template files to your root template.
